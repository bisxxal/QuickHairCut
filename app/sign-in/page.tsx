...
//       <div className='w-full mt-20 center gap-20 flex-col '>
//         <h1 className='text-7xl text-center max-md:text-4xl text-[#9f5df0] font-bold mt-10 appear'>Sign-in && No wait && haircur.</h1>
//         <button className="popupOpen cursor-pointer shadow-xl center gap-3 text-xl px-8 py-3 rounded-full buttonbg" onClick={() => signIn('google')}> sign in with google </button>
//       </div>
//     </div>
//   )
// }
...
import { Scissors, User, Mail, Lock, ChevronRight, Sparkles } from 'lucide-react';
import { useRouter } from 'next/navigation';
import { getSession, signIn } from 'next-auth/react';
...
const SignInPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-10 min-h-screen mt-10 flex items-center justify-center px-6">
